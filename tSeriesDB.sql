...
-- Como en el capitulo 7 del libro se crea: `tSeriesDB`

-- Siguiendo con los pasos del capitulo 7 se crea una tabla para la BD

-- Crear tabla `datosIOT` con la siguiente estructura:

CREATE TABLE `datosIOT` (
  `id` int(11) NOT NULL,
...
--El siguiente paso es llenar la tabla creada

INSERT INTO `datosIOT` (`id`, `topic`, `payload`, `timestamp`, `deleted`) VALUES
...
--Se agrega el indice para nuestra tabla

ALTER TABLE `datosIOT`
  ADD PRIMARY KEY (`id`);
